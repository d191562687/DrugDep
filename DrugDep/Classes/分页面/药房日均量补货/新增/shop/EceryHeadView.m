...
@interface EceryHeadView ()<FSComboPickerViewDelegate>

@end

@implementation EceryHeadView
...
- (void)setupSubViews
{
    ...
    //天数选择
    UILabel * label4 = [[UILabel alloc]initWithFrame:CGRectMake(SCREEN_WIDTH * 0.05, SCREEN_WIDTH * 0.41, SCREEN_WIDTH * 0.3, SCREEN_WIDTH * 0.1)];
    label4.text = @"天数选择:";
    [self addSubview:label4];
    
    UIImageView * imageView4 = [[UIImageView alloc]initWithFrame:CGRectMake(0, SCREEN_WIDTH * 0.52, SCREEN_WIDTH, 1)];
    imageView4.backgroundColor = [UIColor groupTableViewBackgroundColor];
    imageView4.alpha = 0.7;
...
//    [self addSubview:buttonUp];
    ...
    [buttonOne setTitle:@"药房日均补货" forState:UIControlStateNormal];
    ...
    //横线
    UIImageView * imageView5 = [[UIImageView alloc]initWithFrame:CGRectMake(0, SCREEN_HEIGHT * 0.58, SCREEN_WIDTH, 3)];
    imageView5.backgroundColor = [UIColor lightGrayColor];
    imagePlan.alpha = 0.2;
