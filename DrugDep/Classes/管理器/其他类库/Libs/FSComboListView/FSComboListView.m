...
#define PICKER_VIEW_HEIGHT 140.0f
...
- (void)initialize
{
    ...
    _pickerView = [[UIPickerView alloc] initWithFrame:CGRectMake(COMBOBOX_MARGIN, COMBOBOX_HEIGHT + 1, self.frame.size.width * 0.55, PICKER_VIEW_HEIGHT)];
...
//    [self.pickerView selectRow:[self.values indexOfObject:[self currentValue]] inComponent:0 animated:NO];
    ...
    UIControl *dropButton =  [[UIControl alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width * 0.62, COMBOBOX_HEIGHT)];
    ...
    the_label.font = [UIFont systemFontOfSize:13];
